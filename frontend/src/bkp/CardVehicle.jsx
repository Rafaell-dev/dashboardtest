...
import { useDeleteVeiculoMutation, usePutVeiculoMutation } from 'state/api'
...
const CardVehicle = ({
  ...
  const [updateVeiculo, { isLoading, isSuccess, isError, error }] =
    usePutVeiculoMutation(category, { refetchOnMountOrArgChange: true })

  const onSubmit = async (values, actions) => {
    try {
      const response = await updateVeiculo(_id, veiculosValues)
      console.log(_id)
      console.log('Dados enviados com sucesso:', response)
    } catch (error) {
      console.log(_id)
      console.log(veiculosValues)
